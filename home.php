    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container">
         ...
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i><?php ?></p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i><?php ?></p>
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i><?php ?></p>
        </div>
      </div>
      <br>
        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <textarea rows="45" contenteditable="true" class="w3-border w3-padding" placeholder="Status : Feeling Well"></textarea>
